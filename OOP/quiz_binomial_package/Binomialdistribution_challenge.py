...
class Binomial(Distribution):
    ...
    def __init__(self, mu=0, sigma=1, probability=0, size=0):
    ...
    def binomial_pdf(self, k):
        ...
        return math.factorial(self.n) / ((math.factorial(self.n) - k) * math.factorial(self.k)) * self.p ^ self.n * (1 - self.p) * (self.n - k)
